...
- **Want to build something with it?** Go to [guide/installation](/docs/guide/installation) and [guide/quick-start](/docs/guide/quick-start).
- **Building an HTTP-facing app?** See [api/index](/docs/api).
- **Managing a deployment?** See [cli/index](/docs/cli).
- **Building a frontend?** See [sdk/index](/docs/sdk).
- **Curious why something was built a certain way?** See [design-decisions](/docs/design-decisions).
- **Want to know what's coming?** See [roadmap](/docs/roadmap).
