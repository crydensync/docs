...
description: "An embeddable, framework-agnostic authentication engine for Go, designed around one core idea: you own your users."
---
...
| `typebook` | A reference full-stack app (Google Keep-style notes) built on CrydenSync — [live demo](https://typebook.vercel.app) | Proof that the whole stack works end-to-end in a real app |
...
- **Want to see it running for real first?** Try [typebook](https://typebook.vercel.app), a live notes app built entirely on CrydenSync v2 — sign up, log in, check active sessions, change your password, all of it.
